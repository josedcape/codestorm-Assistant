...
export default function TerminalView({ lines }: TerminalViewProps) {
  ...
  return (
    <motion.div 
      ref={terminalRef}
      className="flex-grow bg-[#121212] rounded-b-xl font-mono p-4 overflow-y-auto text-sm"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="text-cyan-400">
        ...
        {/* Blinking cursor */}
        <div className="inline-block w-2 h-4 bg-cyan-400 ml-1 animate-[blink_1s_step-end_infinite]"></div>
      </div>
    </motion.div>
  );
}
